 ...
 * 
 * Contains links to the careers, blog, and about pages,
 * as well as a language and currency selector.
 * 
 * Also contains a list of links to the conditions of use,
 * privacy policy, and help pages.
 * 
 * Finally, it contains a copyright notice and an address.
 */

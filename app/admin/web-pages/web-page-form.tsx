...
import { WebPageInputSchema, WebPageSchema } from '@/lib/validator'
...
/**
 * WebPageForm is a component that renders a form to create or update a web page.
 *
 * @param {Object} props - The props object.
 * @param {string} props.type - The type of form to render, either 'Create' or 'Update'.
 * @param {IWebPage} [props.webPage] - The web page object to update, if any.
 * @param {string} [props.webPageId] - The ID of the web page to update, if any.
 *
...
const WebPageForm = ({
  ...
  // const updateResolver = zodResolver(WebPageUpdateSchema, {
  //   values: (values: z.infer<typeof WebPageUpdateSchema>) => ({ ...values, _id: webPageId }),
  // });

  const form = useForm<z.infer<typeof WebPageSchema>>({

...
/**
 * The OverviewReport component renders a dashboard with key statistics
 * and charts to help admin users quickly understand the state of their
 * store. It displays total revenue, number of sales, customers, and
 * products. It also displays an area chart of sales over time, a table
 * of best-selling products, a pie chart of best-selling categories,
 * and a table of recent sales.
 *
 * The component uses the `getOrderSummary` function from
 * `lib/actions/order.actions` to fetch the necessary data. It also uses
 * the `useTransition` hook from `react` to handle the loading state.
 * 
 **/

...
/**
 * A component that displays a list of customer reviews for a product.
 *
 * @example
 * <ReviewList product={product} userId={userId} />
 *
 * @param {IProduct} product - The product to display reviews for.
 * @param {string | undefined} userId - The ID of the current user. If provided, the component will
...
export default function ReviewList({
   ...
   *
   * This function is used to refetch the reviews after a user submits a review.
   * It will fetch the reviews from the server and update the component state.
   *
  ...
  /**
   * Loads more reviews from the server.
   *
   * This function is used to fetch more reviews when the user clicks the "Load more" button.
   * It will fetch the next page of reviews from the server and update the component state.
   *
   * @returns {Promise<void>}
   */
  ...
  useEffect(() => {
    ...
    // Only load on a scroll to the reviews section and not on page load
    if (inView) {
      loadReviews()
    }
   ...
   *
   * This function is used as the onSubmit handler for the review form. It will
   * create or update a review in the database based on the form values.
   * If the operation is successful, it will close the form and reload the
   * reviews list. If the operation fails, it will display an error message.
   * @param {CustomerReview} values - The form values.
   * @returns {Promise<void>}
   */

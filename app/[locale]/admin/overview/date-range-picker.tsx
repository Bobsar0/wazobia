 ...
 *   defaultDate={{ from: new Date('2022-01-01'), to: new Date('2022-01-31') }}
 *   setDate={(date) => setState(date)}
 * />
 *
 * @param {DateRange} [defaultDate] The default date range to display.
 * @param {(date: DateRange | undefined) => void} setDate The function to call when the date range changes.
 * @param {string} [className] The class name to apply to the container element.

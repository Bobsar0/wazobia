...
/**
 * OverviewReport component renders the dashboard page for admin.
 * It displays the total revenue, sales, customers, products, sales overview,
 * how much you're earning, product performance, best-selling categories, and
 * recent sales.
 *
 * @requires t - next-intl translations
 * @requires getOrderSummary - fetches order summary data
 * @returns JSX.Element
 */

...
/**
 * Renders the admin page for managing web pages.
 *
 * Retrieves all web pages and displays them in a table format with columns for
 * ID, name, slug, publication status, and actions. Provides a button to create
 * a new web page and options to edit or delete existing pages.
 *
 * @returns {JSX.Element} The admin web pages management interface.
 */

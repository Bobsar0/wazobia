...
/**
 * SettingForm is a React component for managing site settings in a form.
 * It utilizes the react-hook-form library to handle form state and validation.
 * The form includes fields for site information, common settings, carousels, languages,
 * currencies, payment methods, and delivery dates.
 * The form also includes a submit button for saving the setting.
 *
 * Props:
 * - setting: The current setting object.
 *
 * @component
 */
const SettingForm = ({ setting }: { setting: ISettingInput }) => {
  ...
  /**
   * Submits the setting form to the server.
   * 
   * @param {ISettingInput} values - The form values.
   * 

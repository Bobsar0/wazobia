...
/**
 * PaymentMethodForm is a React component for managing the available payment
 * methods and the default payment method.
 *
 * Props:
 ...
 *
 * The component renders a form with input fields for adding and managing payment
 * methods. It also renders a select field for setting the default payment method.
 * The component utilizes the react-hook-form library to handle form state and
 * validation.
 */
export default function PaymentMethodForm({
  ...
  useEffect(() => {
    ...
    if (validCodes && !validCodes.includes(defaultPaymentMethod)) {

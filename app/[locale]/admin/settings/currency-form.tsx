...
/**
 * A form component for managing a list of available currencies and the default
 * currency.
 *
 * @param {UseFormReturn<ISettingInput>} form - The form instance.
...
export default function CurrencyForm({
  ...
  useEffect(() => {
    ...
    if (validCodes && !validCodes.includes(defaultCurrency)) {

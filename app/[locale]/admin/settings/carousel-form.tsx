...
/**
 * CarouselForm is a component for managing a list of carousels within a form.
 * It utilizes the react-hook-form library to provide form handling capabilities
 * and allows users to add, edit, and remove carousel items. Each carousel item
 * consists of a title, URL, button caption, and an image. Users can upload an
 * image or provide an image URL directly. The component displays validation
 * messages for fields and handles upload errors gracefully.
 *
 * Props:
